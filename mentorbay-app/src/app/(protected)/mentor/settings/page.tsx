      ...
      <form action={updateProfileAction} className="space-y-6">
        ...
        <section className="bg-white rounded-2xl shadow-card p-6">
          ...
          <div className="space-y-4">
            ...
            <div><label className="block text-sm font-semibold text-navy mb-1">Years of experience</label><input name="experience_years" type="number" min={0} max={60} defaultValue={profile?.experience_years ?? 0} className="w-full px-4 py-2.5 rounded-lg border border-slate-200 focus:ring-2 focus:ring-teal outline-none" placeholder="e.g. 8" /></div>
